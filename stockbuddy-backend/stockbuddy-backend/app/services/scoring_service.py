...
class ScoringService:
    ...
    def calculate_final_score(
        ...
        """
        # 加權計算
        weighted_tech = technical_score * cls.WEIGHTS["technical"]
        weighted_fund = fundamental_score * cls.WEIGHTS["fundamental"]
        weighted_chip = chip_score * cls.WEIGHTS["chip"]
        weighted_news = news_score * cls.WEIGHTS["news"]
        ...
        return {
            ...
            "breakdown": {
                ...
                "chip": {
                    "score": chip_score,
                    "weight": cls.WEIGHTS["chip"],
                    "weighted": round(weighted_chip, 1),
                },
                "news": {
                    "score": news_score,
                    "weight": cls.WEIGHTS["news"],
...
# V10.11 新增便捷函數
def calculate_margin_score(margin_balance=None, margin_balance_prev=None, short_balance=None, short_balance_prev=None):
    return ScoringService.calculate_margin_score(margin_balance, margin_balance_prev, short_balance, short_balance_prev)
