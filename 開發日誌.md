...
## 當前待修復問題清單 (2026-01-15 更新)

> **來源**: V10.41-AI升級包 (2026-01-15 Phase 1 完成)
> **系統版本**: V10.41 (AI 升級版)
> **設計文檔**: C:\Users\USER\.claude\plans\synthetic-mapping-wilkinson.md

### V10.41 AI 升級包 - Phase 1 (2026-01-15 完成)

| # | 修改項目 | 說明 | 狀態 |
|---|----------|------|------|
| 1 | SHAP 解釋模組 | 新增 shap_explainer.py，提供 ML 預測可解釋性 | ✅ |
| 2 | FinBERT 情緒分析 | 新增 finbert_sentiment.py，支援中英文金融新聞情緒分析 | ✅ |
| 3 | SHAP API | 新增 /api/stocks/ml/explain/{stock_id} API | ✅ |
| 4 | FinBERT API | 新增 /api/stocks/ml/sentiment/{stock_id} API | ✅ |
| 5 | SHAPWaterfall.jsx | 新增 SHAP 瀑布圖前端元件 | ✅ |
| 6 | PredictionExplainer.jsx | 新增完整 AI 分析面板 (SHAP + FinBERT + TFT 預測) | ✅ |
| 7 | requirements.txt | 新增 shap, transformers, torch 依賴 | ✅ |
| 8 | 測試腳本 | 新增 tests/test_phase1.py 驗證 Phase 1 功能 | ✅ |
...
### V10.41 AI 升級包 - Phase 2 (2026-01-15 完成)

| # | 修改項目 | 說明 | 狀態 |
|---|----------|------|------|
| 1 | TFT 預測模組 | 新增 tft_predictor.py，Temporal Fusion Transformer 時間序列預測 | ✅ |
| 2 | TFT API | 新增 /api/stocks/ml/forecast/{stock_id} API | ✅ |
| 3 | 規則引擎備案 | 模型不存在時使用線性外推 | ✅ |
| 4 | requirements.txt | 新增 pytorch-forecasting, pytorch-lightning 依賴 | ✅ |
| 5 | 測試腳本 | 新增 tests/test_phase2_tft.py | ✅ |
...
### V10.41 AI 升級包 - Phase 3 (2026-01-15 完成)

| # | 修改項目 | 說明 | 狀態 |
|---|----------|------|------|
| 1 | RL 交易代理 | 新增 rl_agent.py，PPO 強化學習倉位配置 | ✅ |
| 2 | 交易環境 | TradingEnvironment 類 (Gymnasium 格式) | ✅ |
| 3 | RL API | 新增 /api/stocks/ml/rl/suggest API | ✅ |
| 4 | 規則引擎備案 | 模型未訓練時使用技術指標規則引擎 | ✅ |
| 5 | requirements.txt | 新增 stable-baselines3, gymnasium 依賴 | ✅ |
| 6 | 測試腳本 | 新增 tests/test_phase3_rl.py | ✅ |
...
- Phase 2: TFT (時間序列預測) ✅
- Phase 3: PPO (強化學習交易代理) ✅
- 所有模組皆有規則引擎備案，確保無依賴時仍可運作
